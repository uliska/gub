;;;; arbora.nsi -- Arbora installer script for Microsoft Windows
;;;; (c) 2005--2010
...
Section "Start Menu Shortcuts"
	...
	IfErrors 0 exit
	Delete "$DESKTOP\Arbora.lnk"
	Delete "$SMPROGRAMS\Arbora\*.*"
	RMDir "$SMPROGRAMS\Arbora"
...
Function create_shortcuts
	...
	CreateShortCut "$SMPROGRAMS\Arbora\Arbora Website.lnk" \
		"http://arbora.org/" "" \
		"firefox.exe" 0
	CreateShortCut "$SMPROGRAMS\Arbora\Uninstall.lnk" \
